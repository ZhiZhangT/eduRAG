...
def vector_search(
    ...
    query_variables: list = ["additional_mathematics", None, None],
    numCandidates: int = 50,
    returnLimit: int = 3,
    mql: bool = False,
) -> list:
    """
    ...
    if mql:
        ...
        sub_topic = get_sub_topic_from_openai(
            user_query, json.dumps(topics), topic, format=SubTopic
        )
    ...
    pipeline = [
        {
            "$vectorSearch": vector_search_obj,
        },
